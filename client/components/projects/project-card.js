    ...
    render() {
        ...
        <modal-component id="activityModal">
          <form id="activityForm">
            ...
            <label for="activityAssignees">Participants</label>
